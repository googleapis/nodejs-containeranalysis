...
describe('v1beta1.ContainerAnalysisV1Beta1Client', () => {
    ...
    describe('getScanConfig', () => {
        it('invokes getScanConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.containeranalysis.v1beta1.GetScanConfigRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.devtools.containeranalysis.v1beta1.ScanConfig());
            client.innerApiCalls.getScanConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.getScanConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getScanConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getScanConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.getScanConfig(request); }, expectedError);
            assert((client.innerApiCalls.getScanConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateScanConfig', () => {
        it('invokes updateScanConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.containeranalysis.v1beta1.UpdateScanConfigRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateScanConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateScanConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateScanConfig(request); }, expectedError);
            assert((client.innerApiCalls.updateScanConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listScanConfigs', () => {
        it('invokes listScanConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.containeranalysis.v1beta1.ListScanConfigsRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listScanConfigs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listScanConfigs with error', async () => {
            ...
            await assert.rejects(async () => { await client.listScanConfigs(request); }, expectedError);
            assert((client.innerApiCalls.listScanConfigs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
