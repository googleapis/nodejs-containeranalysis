...
const grafeasv1beta1Module = require('../src');
...
describe('v1beta1.GrafeasV1Beta1Client', () => {
  ...
  describe('getOccurrence', () => {
    it('invokes getOccurrence without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IGetOccurrenceRequest = {};
      request.name = '';
      // Mock response
    ...
    it('invokes getOccurrence with error', done => {
      ...
      client.getOccurrence(request, (err: FakeError, response: {}) => {
  ...
  describe('deleteOccurrence', () => {
    it('invokes deleteOccurrence without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IDeleteOccurrenceRequest = {};
      request.name = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
      ...
      client.deleteOccurrence(request, (err: {}, response: {}) => {
        assert.ifError(err);
        assert.deepStrictEqual(response, expectedResponse);
        done();
      });
    ...
    it('invokes deleteOccurrence with error', done => {
      ...
      client.deleteOccurrence(request, (err: FakeError, response: {}) => {
        assert(err instanceof FakeError);
        assert.strictEqual(err.code, FAKE_STATUS_CODE);
        assert(typeof response === 'undefined');
        done();
  ...
  describe('createOccurrence', () => {
    it('invokes createOccurrence without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.ICreateOccurrenceRequest = {};
      request.parent = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
    ...
    it('invokes createOccurrence with error', done => {
      ...
      client.createOccurrence(request, (err: FakeError, response: {}) => {
        assert(err instanceof FakeError);
        assert.strictEqual(err.code, FAKE_STATUS_CODE);
        assert(typeof response === 'undefined');
        done();
  ...
  describe('batchCreateOccurrences', () => {
    it('invokes batchCreateOccurrences without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IBatchCreateOccurrencesRequest = {};
      request.parent = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
    ...
    it('invokes batchCreateOccurrences with error', done => {
      ...
      client.batchCreateOccurrences(request, (err: FakeError, response: {}) => {
        assert(err instanceof FakeError);
        assert.strictEqual(err.code, FAKE_STATUS_CODE);
        assert(typeof response === 'undefined');
        done();
  ...
  describe('updateOccurrence', () => {
    it('invokes updateOccurrence without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IUpdateOccurrenceRequest = {};
      request.name = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
    ...
    it('invokes updateOccurrence with error', done => {
      ...
      client.updateOccurrence(request, (err: FakeError, response: {}) => {
        assert(err instanceof FakeError);
        assert.strictEqual(err.code, FAKE_STATUS_CODE);
        assert(typeof response === 'undefined');
        done();
  ...
  describe('getOccurrenceNote', () => {
    it('invokes getOccurrenceNote without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IGetOccurrenceNoteRequest = {};
      request.name = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
    ...
    it('invokes getOccurrenceNote with error', done => {
      ...
      client.getOccurrenceNote(request, (err: FakeError, response: {}) => {
        assert(err instanceof FakeError);
        assert.strictEqual(err.code, FAKE_STATUS_CODE);
        assert(typeof response === 'undefined');
        done();
  ...
  describe('getNote', () => {
    it('invokes getNote without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IGetNoteRequest = {};
      request.name = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
    ...
    it('invokes getNote with error', done => {
      ...
      client.getNote(request, (err: FakeError, response: {}) => {
        assert(err instanceof FakeError);
        assert.strictEqual(err.code, FAKE_STATUS_CODE);
        assert(typeof response === 'undefined');
        done();
  ...
  describe('deleteNote', () => {
    it('invokes deleteNote without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IDeleteNoteRequest = {};
      request.name = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
      ...
      client.deleteNote(request, (err: {}, response: {}) => {
        assert.ifError(err);
        assert.deepStrictEqual(response, expectedResponse);
        done();
      });
    ...
    it('invokes deleteNote with error', done => {
      ...
      client.deleteNote(request, (err: FakeError, response: {}) => {
        assert(err instanceof FakeError);
        assert.strictEqual(err.code, FAKE_STATUS_CODE);
        assert(typeof response === 'undefined');
        done();
  ...
  describe('createNote', () => {
    it('invokes createNote without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.ICreateNoteRequest = {};
      request.parent = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
    ...
    it('invokes createNote with error', done => {
      ...
      client.createNote(request, (err: FakeError, response: {}) => {
        assert(err instanceof FakeError);
        assert.strictEqual(err.code, FAKE_STATUS_CODE);
        assert(typeof response === 'undefined');
        done();
  ...
  describe('batchCreateNotes', () => {
    it('invokes batchCreateNotes without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IBatchCreateNotesRequest = {};
      request.parent = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
    ...
    it('invokes batchCreateNotes with error', done => {
      ...
      client.batchCreateNotes(request, (err: FakeError, response: {}) => {
        assert(err instanceof FakeError);
        assert.strictEqual(err.code, FAKE_STATUS_CODE);
        assert(typeof response === 'undefined');
        done();
  ...
  describe('updateNote', () => {
    it('invokes updateNote without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IUpdateNoteRequest = {};
      request.name = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
    ...
    it('invokes updateNote with error', done => {
      ...
      client.updateNote(request, (err: FakeError, response: {}) => {
        assert(err instanceof FakeError);
        assert.strictEqual(err.code, FAKE_STATUS_CODE);
        assert(typeof response === 'undefined');
        done();
  ...
  describe('getVulnerabilityOccurrencesSummary', () => {
    it('invokes getVulnerabilityOccurrencesSummary without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IGetVulnerabilityOccurrencesSummaryRequest = {};
      request.parent = '';
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
  ...
  describe('listOccurrences', () => {
    it('invokes listOccurrences without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IListOccurrencesRequest = {};
      request.parent = '';
      // Mock response
      const expectedResponse = {};
      // Mock Grpc layer
      ...
      client.listOccurrences(request, (err: FakeError, response: {}) => {
        assert.ifError(err);
        assert.deepStrictEqual(response, expectedResponse);
        done();
      });
  ...
  describe('listOccurrencesStream', () => {
    it('invokes listOccurrencesStream without error', done => {
      const client = new grafeasv1beta1Module.v1beta1.GrafeasV1Beta1Client({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('listNotes', () => {
    it('invokes listNotes without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IListNotesRequest = {};
      request.parent = '';
      // Mock response
      const expectedResponse = {};
      // Mock Grpc layer
      ...
      client.listNotes(request, (err: FakeError, response: {}) => {
        assert.ifError(err);
        assert.deepStrictEqual(response, expectedResponse);
        done();
      });
  ...
  describe('listNotesStream', () => {
    it('invokes listNotesStream without error', done => {
      const client = new grafeasv1beta1Module.v1beta1.GrafeasV1Beta1Client({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('listNoteOccurrences', () => {
    it('invokes listNoteOccurrences without error', done => {
      ...
      // Mock request
      const request: protosTypes.grafeas.v1beta1.IListNoteOccurrencesRequest = {};
      request.name = '';
      // Mock response
      const expectedResponse = {};
      // Mock Grpc layer
      ...
      client.listNoteOccurrences(request, (err: FakeError, response: {}) => {
        assert.ifError(err);
        assert.deepStrictEqual(response, expectedResponse);
        done();
      });
  ...
  describe('listNoteOccurrencesStream', () => {
    it('invokes listNoteOccurrencesStream without error', done => {
      const client = new grafeasv1beta1Module.v1beta1.GrafeasV1Beta1Client({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
