...
describe('v1beta1.GrafeasClient', () => {
  it('has servicePath', () => {
    const servicePath = grafeasModule.v1beta1.GrafeasClient.servicePath;
    assert(servicePath);
  });
  it('has apiEndpoint', () => {
    const apiEndpoint = grafeasModule.v1beta1.GrafeasClient.apiEndpoint;
    assert(apiEndpoint);
  });
  it('has port', () => {
    const port = grafeasModule.v1beta1.GrafeasClient.port;
    assert(port);
    assert(typeof port === 'number');
  });
  it('should create a client with no option', () => {
    const client = new grafeasModule.v1beta1.GrafeasClient();
    assert(client);
  });
