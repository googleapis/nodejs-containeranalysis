...
describe('v1beta1.GrafeasV1Beta1Client', () => {
    ...
    describe('getOccurrence', () => {
        it('invokes getOccurrence without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.grafeas.v1beta1.Occurrence());
        ...
        it('invokes getOccurrence with error', async () => {
            ...
            assert.rejects(async () => { await client.getOccurrence(request); }, expectedError);
            assert((client.innerApiCalls.getOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteOccurrence', () => {
        ...
        it('invokes deleteOccurrence with error', async () => {
            ...
            assert.rejects(async () => { await client.deleteOccurrence(request); }, expectedError);
            assert((client.innerApiCalls.deleteOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createOccurrence', () => {
        ...
        it('invokes createOccurrence with error', async () => {
            ...
            assert.rejects(async () => { await client.createOccurrence(request); }, expectedError);
            assert((client.innerApiCalls.createOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('batchCreateOccurrences', () => {
        it('invokes batchCreateOccurrences without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.grafeas.v1beta1.BatchCreateOccurrencesResponse());
        ...
        it('invokes batchCreateOccurrences with error', async () => {
            ...
            assert.rejects(async () => { await client.batchCreateOccurrences(request); }, expectedError);
            assert((client.innerApiCalls.batchCreateOccurrences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateOccurrence', () => {
        ...
        it('invokes updateOccurrence with error', async () => {
            ...
            assert.rejects(async () => { await client.updateOccurrence(request); }, expectedError);
            assert((client.innerApiCalls.updateOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getOccurrenceNote', () => {
        it('invokes getOccurrenceNote without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.grafeas.v1beta1.Note());
        ...
        it('invokes getOccurrenceNote with error', async () => {
            ...
            assert.rejects(async () => { await client.getOccurrenceNote(request); }, expectedError);
            assert((client.innerApiCalls.getOccurrenceNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getNote', () => {
        ...
        it('invokes getNote with error', async () => {
            ...
            assert.rejects(async () => { await client.getNote(request); }, expectedError);
            assert((client.innerApiCalls.getNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteNote', () => {
        ...
        it('invokes deleteNote with error', async () => {
            ...
            assert.rejects(async () => { await client.deleteNote(request); }, expectedError);
            assert((client.innerApiCalls.deleteNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createNote', () => {
        ...
        it('invokes createNote with error', async () => {
            ...
            assert.rejects(async () => { await client.createNote(request); }, expectedError);
            assert((client.innerApiCalls.createNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('batchCreateNotes', () => {
        it('invokes batchCreateNotes without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.grafeas.v1beta1.BatchCreateNotesResponse());
        ...
        it('invokes batchCreateNotes with error', async () => {
            ...
            assert.rejects(async () => { await client.batchCreateNotes(request); }, expectedError);
            assert((client.innerApiCalls.batchCreateNotes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateNote', () => {
        ...
        it('invokes updateNote with error', async () => {
            ...
            assert.rejects(async () => { await client.updateNote(request); }, expectedError);
            assert((client.innerApiCalls.updateNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getVulnerabilityOccurrencesSummary', () => {
        it('invokes getVulnerabilityOccurrencesSummary without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.grafeas.v1beta1.VulnerabilityOccurrencesSummary());
        ...
        it('invokes getVulnerabilityOccurrencesSummary with error', async () => {
            ...
            assert.rejects(async () => { await client.getVulnerabilityOccurrencesSummary(request); }, expectedError);
            assert((client.innerApiCalls.getVulnerabilityOccurrencesSummary as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listOccurrences', () => {
        ...
        it('invokes listOccurrences with error', async () => {
            ...
            assert.rejects(async () => { await client.listOccurrences(request); }, expectedError);
            assert((client.innerApiCalls.listOccurrences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listNotes', () => {
        ...
        it('invokes listNotes with error', async () => {
            ...
            assert.rejects(async () => { await client.listNotes(request); }, expectedError);
            assert((client.innerApiCalls.listNotes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listNoteOccurrences', () => {
        ...
        it('invokes listNoteOccurrences with error', async () => {
            ...
            assert.rejects(async () => { await client.listNoteOccurrences(request); }, expectedError);
            assert((client.innerApiCalls.listNoteOccurrences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
