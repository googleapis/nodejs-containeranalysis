...
describe('v1beta1.GrafeasV1Beta1Client', () => {
    ...
    describe('getOccurrence', () => {
        it('invokes getOccurrence without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetOccurrenceRequest', ['name']);
    ...
    describe('deleteOccurrence', () => {
        it('invokes deleteOccurrence without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteOccurrenceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createOccurrence', () => {
        it('invokes createOccurrence without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateOccurrenceRequest', ['parent']);
    ...
    describe('batchCreateOccurrences', () => {
        it('invokes batchCreateOccurrences without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('BatchCreateOccurrencesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateOccurrence', () => {
        it('invokes updateOccurrence without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateOccurrenceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.grafeas.v1beta1.Occurrence()
    ...
    describe('getOccurrenceNote', () => {
        it('invokes getOccurrenceNote without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetOccurrenceNoteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getNote', () => {
        it('invokes getNote without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetNoteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.grafeas.v1beta1.Note()
    ...
    describe('deleteNote', () => {
        it('invokes deleteNote without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteNoteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createNote', () => {
        it('invokes createNote without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateNoteRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.grafeas.v1beta1.Note()
    ...
    describe('batchCreateNotes', () => {
        it('invokes batchCreateNotes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('BatchCreateNotesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateNote', () => {
        it('invokes updateNote without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateNoteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.grafeas.v1beta1.Note()
    ...
    describe('getVulnerabilityOccurrencesSummary', () => {
        it('invokes getVulnerabilityOccurrencesSummary without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetVulnerabilityOccurrencesSummaryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listOccurrences', () => {
        it('invokes listOccurrences without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListOccurrencesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listNotes', () => {
        it('invokes listNotes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListNotesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listNoteOccurrences', () => {
        it('invokes listNoteOccurrences without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListNoteOccurrencesRequest', ['name']);
            request.name = defaultValue1;
