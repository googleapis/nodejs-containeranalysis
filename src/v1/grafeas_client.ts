...
export class GrafeasClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    const defaults = gaxGrpc.constructSettings(
        'google.devtools.containeranalysis.v1.Grafeas', gapicConfig as gax.ClientConfig,
    ...
    this.grafeasStub = gaxGrpc.createStub(
        opts.fallback ?
          (protos as protobuf.Root).lookupService('google.devtools.containeranalysis.v1.Grafeas') :
          // tslint:disable-next-line no-any
          (protos as any).google.devtools.containeranalysis.v1.Grafeas,
