...
export class ContainerAnalysisV1Beta1Client {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._descriptors.page = {
      listScanConfigs:
          new gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'scanConfigs')
    };
    ...
    this.containerAnalysisV1Beta1Stub = gaxGrpc.createStub(
        opts.fallback ?
          (protos as protobuf.Root).lookupService('google.devtools.containeranalysis.v1beta1.ContainerAnalysisV1Beta1') :
          // tslint:disable-next-line no-any
          (protos as any).google.devtools.containeranalysis.v1beta1.ContainerAnalysisV1Beta1,
